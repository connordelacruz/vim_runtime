...
" Custom highlight groups for vim-matchup
call <sid>hi("MatchWord",     "", s:gui01, "", s:cterm03,  "underline", "")
" end
...
call <sid>hi("TabLineSel",    s:gui07, s:gui0D, s:cterm0B, s:cterm01, "none", "")
