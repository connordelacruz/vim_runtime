...
let s:p.normal.left = [[["#ffffff", 15], ["#6699cc", 68], 'bold'], [["#ffffff", 15], ["#578FC7", 243]]]
let s:p.normal.middle = [[["#ffffff", 15], ["#578FC7", 237]]]
...
let s:p.insert.left = [[["#ffffff", 15], ["#5FB3B3", 114], 'bold'], [["#ffffff", 15], ["#4EA6A6", 243]]]
let s:p.insert.middle = [[["#ffffff", 15], ["#4EA6A6", 237]]]
let s:p.insert.right = [[["#ffffff", 15], ["#5FB3B3", 243]], [["#ffffff", 15], ["#5FB3B3", 114]]]

let s:p.replace.left = [[["#ffffff", 15], ["#ec5f67", 203], 'bold'], [["#ffffff", 15], ["#d4555c", 243]]]
let s:p.replace.middle = [[["#ffffff", 15], ["#d4555c", 237]]]
let s:p.replace.right = [[["#ffffff", 15], ["#ec5f67", 243]], [["#ffffff", 15], ["#ec5f67", 203]]]

let s:p.visual.left = [[["#ffffff", 15], ["#FAC863", 209], 'bold'], [["#ffffff", 15], ["#F9B939", 243]]]
let s:p.visual.middle = [[["#ffffff", 15], ["#F9B939", 237]]]
let s:p.visual.right = [[["#ffffff", 15], ["#FAC863", 243]], [["#ffffff", 15], ["#FAC863", 209]]]
